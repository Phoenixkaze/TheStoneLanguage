...
public class OperationCode {
    ...
    public static byte encodeRegister(int register) {
        if (register > StoneVirtualMachine.NUMOFREG) {
            throw new SecurityException("too many registers required");
        } else {
    ...
    public static byte encodeOffset(int offset) throws StoneException {
    ...
    public static short encodeShortOffset(int offset) throws StoneException {
